...
android {
    namespace = "com.dark.plugins.expense"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
    ...
    defaultConfig {
        applicationId = "com.dark.plugins.expense"
        minSdk = 31
        targetSdk = 36
        versionCode = 1
        versionName = "1.0.0"
...
tasks.register<Zip>("packagePlugin") {
    ...
    from(layout.projectDirectory.file("model.onnx"))
    from(layout.projectDirectory.file("vocab.txt"))
}
